...
const Cubes: React.FC<CubesProps> = ({
  ...
  useEffect(() => {
    ...
    if (!autoAnimate || !sceneRef.current || prefersReducedMotion) return;
  ...
  return (
    <div className="relative w-full max-w-lg mx-auto max-md:w-11/12 aspect-square" style={wrapperStyle}>
